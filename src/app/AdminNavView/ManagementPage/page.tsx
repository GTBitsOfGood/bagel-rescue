...
function ManagementPage() {
  ...
  const { loadingProgress, showContent: showVolunteers } =
    useLoadingProgress(volunteersLoading);
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="bg-[#ECF2F9] flex flex-col pl-9 pr-9 gap-6 min-h-screen">
          <div className="flex justify-between text-[#6C7D93] mt-6">
            <div className="px-5 py-[.6rem] rounded-xl space-x-2 border bg-white flex items-center">
              <FontAwesomeIcon
            ...
            <div className="flex flex-row gap-4 justify-center items-center text-[var(--Bagel-Rescue-Dark-Blue-2,#072b68)]">
              ...
              <button className="px-5 py-[.6rem] rounded-lg space-x-2 border bg-white flex items-center">
                <span>Alphabetically</span>
                <FontAwesomeIcon icon={faChevronDown} height={16} width={16} />
              </button>
