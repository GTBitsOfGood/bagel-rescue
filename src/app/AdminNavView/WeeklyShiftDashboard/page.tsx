...
function WeeklyShiftDashboard() {
    ...
    const assignedCount = weeklyShiftData.filter((shift: any) => shift.status === "assigned").length;
    const openCount = weeklyShiftData.filter((shift: any) => shift.status === "open").length;
