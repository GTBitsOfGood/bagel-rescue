    ...
    <div className="main-sidebar">
      ...
      <div className="sidebar-content">
              ...
              <div className="flex gap-2">
                <button
                  onClick={async () => {
                    ...
                    const dateKey = shiftSidebarInfo.shiftDate
                      .toISOString()
                      .split("T")[0];
                    ...
                    try {
                      ...
                      console.error(error);
                      errorToast("Could not save comment");
                    }
                  }}
        ...
        <div className="sidebar-content-header">
          <h3> Time</h3>
          <p>
            {new Date(shift.shiftStartTime).toLocaleTimeString("en-US", {
              hour: "numeric",
              minute: "2-digit",
              hour12: true,
            })}{" "}
            -{" "}
            {new Date(shift.shiftEndTime).toLocaleTimeString("en-US", {
              hour: "numeric",
              minute: "2-digit",
              hour12: true,
            })}
