...
const getDays = (recurrenceRule: string): string => {
  ...
  try {
    ...
    if (byDayPart) {
      const dayCodes = byDayPart.substring(6).split(',');
  ...
  return (
    <div className="main-sidebar">
      <div className="sidebar-header">
        ...
        <div className="group flex items-center gap-2.5 bg-white text-[#00377A] font-[500] 
            p-[.8rem] px-4 rounded-xl border-2 border-[var(--Bagel-Rescue-Light-Grey,#D3D8DE)]
            hover:bg-[#005bb5] hover:text-white cursor-pointer">
          <svg 
      ...
      <div className="sidebar-content">
        ...
        <div className="sidebar-content-header">
          <h3>Days</h3>
          <p>{getDays(shift.recurrenceRule.toString())}</p>
        </div>
        <div className="sidebar-content-header">
          <h3>Time</h3>
          <p>{new Date(shift.shiftDate).toLocaleTimeString(
            "en-US", {
              hour: "numeric",
              minute: "2-digit",
              hour12: true
            }
          )} - {new Date(shift.shiftEndDate).toLocaleTimeString(
            "en-US", {
              hour: "numeric",
              minute: "2-digit",
              hour12: true
        ...
        <div className="sidebar-content-header">
          ...
          <div className="volunteer-container">
            {volunteers.map((name, index) => (
              <div className="volunteer-item" key={`${shift._id.toString()}-${index}`}>
