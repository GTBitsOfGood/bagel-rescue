...
export default function PostShiftForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!completed) {
      errorToast("Please select if you completed your route.");
      return;
    }
    ...
    if (hours === "" || hoursInt < 0) {
      errorToast("Please enter valid hours (0 or more).");
      return;
    }
    if (minutes === "" || minutesInt < 0) {
      errorToast("Please enter valid minutes (0 or more).");
      return;
    }
    ...
    successToast("Thank you for submitting!");
            ...
            <div className={styles.formContainer}>
              ...
              <div className={styles.formBodyContainer}>
                <form onSubmit={handleSubmit} className={styles.formBody}>
                  ...
                  <div>
                    <div className={styles.formQuestion}>
                      * Approximately how many bagels did you pick up?
                    </div>
                    <input
              ...
              <div className={styles.formFooter}>
                <span>
                  If you ran into any issues on your route, please contact
                </span>
