...
const MyShiftsPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<"myShifts" | "openShifts">(
    "myShifts"
  );
    ...
    <div className={styles.container}>
      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.tabContainer}>
          ...
          <button
            className={`${styles.tabButton} ${
              activeTab === "openShifts" ? styles.activeTab : ""
            }`}
        ...
        {!loading &&
          !error &&
          (activeTab === "myShifts" ? shifts : openShifts).length > 0 && (
            <Pagination
              total={
                activeTab === "myShifts"
                  ? pagination.total
                  : openShiftsPagination.total
              }
              page={
                activeTab === "myShifts"
                  ? pagination.page
              ...
              totalPages={
                activeTab === "myShifts"
                  ...
                  : openShiftsPagination.totalPages
              }
              onPageChange={(page) => {
